/** @file TLSServerSocketWrapper.h TLSServerSocketWrapper */
/*
...
#ifndef _MBED_HTTPS_TLS_SERVER_SOCKET_WRAPPER_H_
#define _MBED_HTTPS_TLS_SERVER_SOCKET_WRAPPER_H_
 ...
 *
 * TLSServerSocketWrapper can use any Socket as a transport. After
 * completing the TLS handshake, it can be used as any Socket would be used.
 *
 */
class TLSServerSocketWrapper : public Socket {
public:
    /** Transport modes */
    ...
    /** Create a TLSServerSocketWrapper.
     *
     ...
     */
    TLSServerSocketWrapper(Socket *transport, const char *hostname = NULL, control_transport control = TRANSPORT_CONNECT_AND_CLOSE);

    /** Destroy a socket wrapper.
     *
     *  Closes socket wrapper if the socket wrapper is still open.
     */
    virtual ~TLSServerSocketWrapper();
     ...
     * @retval NSAPI_ERROR_PARAMETER in case the provided root_ca parameter failed parsing.
     */
    nsapi_error_t set_server_cert_key(const void *server_cert, size_t server_cert_len,
     ...
     * @retval NSAPI_ERROR_PARAMETER in case the provided root_ca parameter failed parsing.
     */
    nsapi_error_t set_server_cert_key(const char *server_cert_pem, const char *server_private_key_pem);
     ...
     */
    nsapi_error_t do_handshake(bool first_call);
    ...
    const char *get_ssl_ciphersuite_and_version();
    const char *get_peer_info();
...
private:
    ...
    bool _srvcert_allocated: 1;
    bool _ssl_conf_allocated: 1;

};

#endif /* MBEDTLS_SSL_SRV_C */
#endif // _MBED_HTTPS_TLS_SERVER_SOCKET_WRAPPER_H_
/** @} */
